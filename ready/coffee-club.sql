...
-- Records of favorite
-- ----------------------------
INSERT INTO `favorite` VALUES ('admin@mail.com', 1001, 1, '2020-10-26 16:48:52');
INSERT INTO `favorite` VALUES ('admin@mail.com', 1003, 1, '2020-10-26 17:20:46');
INSERT INTO `favorite` VALUES ('admin@mail.com', 1005, 0, '2020-10-26 17:19:31');
...
INSERT INTO `favorite` VALUES ('admin@mail.com', 1024, 0, '2020-10-29 20:09:20');
...
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES ('00411460f7c92d2124a67ea0f4cb5f85', 'admin@mail.com', 1, 2, '51.4', '2020-10-29 20:00:34');
INSERT INTO `order` VALUES ('9431c87f273e507e6040fcb07dcb4509', 'admin@mail.com', 1, 2, '36', '2020-10-29 19:58:27');
INSERT INTO `order` VALUES ('cee631121c2ec9232f3a2f028ad5c89b', 'admin@mail.com', 1, 4, '71.2', '2020-10-29 19:58:40');
...
INSERT INTO `order_list` VALUES (21, '9431c87f273e507e6040fcb07dcb4509', 1003, 2, '陨石拿铁', 18.00, '冷_全糖_无奶油', 'http://127.0.0.1:3002/imgs/1003.jpg');
INSERT INTO `order_list` VALUES (22, 'cee631121c2ec9232f3a2f028ad5c89b', 1023, 4, '法式三明治', 17.80, '中份', 'http://127.0.0.1:3002/imgs/1023.jpg');
INSERT INTO `order_list` VALUES (23, '00411460f7c92d2124a67ea0f4cb5f85', 1011, 2, '抹茶蛋糕', 25.70, '加奶油_有果碎', 'http://127.0.0.1:3002/imgs/1011.jpg');
...
CREATE TABLE `user`  (
  ...
  `imgpath` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin@mail.com', 'admin', '000000', '1603973421464.jpg');
INSERT INTO `user` VALUES (4, 'li@mail.com', '李四', '0', '');
...
CREATE TABLE `user_commit`  (
  ...
  `committext` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `sysdate` datetime(0) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `user_commit` VALUES ('admin@mail.com', '这个真的不错', '2020-10-20 20:18:53');
INSERT INTO `user_commit` VALUES ('li@mail.com', 'sdsfsd12345678902134567890', '2020-10-12 20:37:48');
